...
public interface PassengersService<Integer, PassengersDto> {
    ...
    ApiResponse<PassengersDto> getWithAllRelationShip(Integer id);

    ApiResponse<PassengersDto> getWithSecurityCheck(Integer id);

    ApiResponse<PassengersDto> getWithNoFlyList(Integer id);
